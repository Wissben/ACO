 ...
 */
public class SATInstance implements Cloneable
{
    // contains for each literal the clauses it satisfies
    protected BitSet[][] literalsBitSet;
    protected PheromonsSAT getPheromonsSAT;
    ...
    public SATInstance clone()
    {
        SATInstance o = null;
        try
        {
            o = (SATInstance) super.clone();
    ...
    public PheromonsSAT getPheromons()
    {
        return getPheromonsSAT;
    }

    public void setPheromons(PheromonsSAT getPheromonsSAT)
    {
        this.getPheromonsSAT = getPheromonsSAT;
    }
